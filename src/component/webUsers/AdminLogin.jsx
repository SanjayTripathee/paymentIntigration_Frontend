...
// <div>
//   <button style={{margin:"20px", cursor:"pointer"}} type='submit'>Login</button>
//   <button style={{cursor:"pointer"}} onClick={()=>navigate("/admin/forgot-password")}>Forget Password</button>
// </div>   
